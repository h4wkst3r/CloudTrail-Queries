...
WHERE 
    e1.eventName IN ('ListModels', 'DescribeModel', 'GetBucketVersioning', 'GetObject', 'PutObject')
    AND e2.eventName IN ('ListModels', 'DescribeModel', 'GetBucketVersioning', 'GetObject', 'PutObject')
